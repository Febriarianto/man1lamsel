...
<body class="login-page"><div class="login-shell"><div class="login-visual"><div><img src="{{ $loginLogo }}" alt="Logo"><span> Dashboard | Administrator</span><h1>Kelola Informasi bersama-sama..</h1><p>Administrator mengelola seluruh portal, sedangkan guru dan pegawai dapat menulis artikel menggunakan akun manual atau SSO Kemenag.</p></div></div><div class="login-form-wrap"><div class="login-form"><a href="{{ route('home') }}" class="back-link"><i class="bi bi-arrow-left"></i> Kembali ke website</a><h2></h2>
