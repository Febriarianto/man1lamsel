...
@section('page_subtitle',$user->usesSso()?'Identitas akun tersinkron dari SSO Kemenag':'Ubah nama, email, dan kata sandi akun lokal')
@section('content')
@if($user->usesSso())
