            ...
            <div class="admin-card p-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" min="0" name="sort_order" value="{{ old('sort_order', $staffMember->sort_order ?? 0) }}" class="form-control" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">NIP</label>
                        <input name="nip" value="{{ old('nip', $staffMember->nip) }}" class="form-control" inputmode="numeric">
                        <small class="text-secondary">Masukkan angka NIP tanpa spasi. Harus sama dengan NIP dari SSO.</small>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Mata Pelajaran/Unit</label>
