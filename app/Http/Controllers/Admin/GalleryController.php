...
class GalleryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data['image'] = $this->storeImage($request->file('image'), 'galleries');
    ...
    public function update(Request $request, Gallery $gallery)
    {
        ...
        $data['image'] = $this->storeImage($request->file('image'), 'galleries', $gallery->image);
        $data['active'] = $request->boolean('active');
        $gallery->update($data);
    ...
    {
        if ($gallery->image && ! str_starts_with($gallery->image, 'demo/')) {
