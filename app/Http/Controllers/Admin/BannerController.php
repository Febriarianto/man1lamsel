...
class BannerController extends Controller
{
    ...
    {
        if ($banner->image && ! str_starts_with($banner->image, 'demo/')) {
    ...
    {
        return $request->validate(['title' => ['required', 'string', 'max:255'], 'subtitle' => ['nullable', 'string', 'max:500'], 'button_text' => ['nullable', 'string', 'max:80'], 'button_url' => ['nullable', 'string', 'max:500'], 'image' => ['nullable', 'image', 'max:4096'], 'sort_order' => ['required', 'integer', 'min:0']]);
    }
}
