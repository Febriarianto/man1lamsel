...
class EventController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data['image'] = $this->storeImage($request->file('image'), 'events');
    ...
    public function update(Request $request, Event $event)
    {
        ...
        $data['image'] = $this->storeImage($request->file('image'), 'events', $event->image);
        $data['active'] = $request->boolean('active');
        $event->update($data);
    ...
    {
        if ($event->image && ! str_starts_with($event->image, 'demo/')) {
